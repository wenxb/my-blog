...
export const SkipNextFill = () => (
    <svg className="yw-icon" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
         fill="currentColor">
        <path
...
export const PlayArrowFill = ({className}) => (
    <svg className={cn("yw-icon", className)} xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960"
